...
Crie as tabelas Cliente, Produto e Vendedor
Crie as colunas que voce achar pertinente, e necessario que todas as tabelas tenham id.
...
Mostrar um tabela com os seguintes dados: 
 - Nome do produto, Preco do Produto, Nome do cliente, Nome do vendedor.
Mostrar a tabela de produtos em ordem alfabetica.
Mostrar a tabela de Clientes em ordem alfabetica.
Mostrar a tabela de Vendedor em ordem alfabetica.
